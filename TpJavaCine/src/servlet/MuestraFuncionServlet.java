...
/**
 * Servlet implementation class MuestraFuncionServlet
 */
@WebServlet("/MuestraFuncionServlet")
public class MuestraFuncionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MuestraFuncionServlet() {
        super();
